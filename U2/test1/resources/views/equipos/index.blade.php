                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('equipos.store')}}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="entrenador" class="form-control" name="entrenador">
                            </div>
